            ...
            <div className='row p-5 mt-5 mb-5'>
               <h1 className='fs-2'>To create a ticket, select a relevant topic</h1>
                ...
                <div className='col-4 p-5  mb-5'>
                   <h4 className=''><i class="fa fa-suitcase" aria-hidden="true"></i> Funds</h4>
                   ...
                   <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>Alerts</a><br/>
                  
 
                </div>
                <div className='col-4 p-5 mb-5'>
                   <h4 className=''><i class="fa fa-search-plus" aria-hidden="true"></i> Console</h4>
                ...
                <div className='col-4 p-5 mb-5'>
                   <h4 className=''><i class="fa fa-adjust" aria-hidden="true"></i> Coin</h4>
